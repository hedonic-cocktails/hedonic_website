...
const seedProducts = [
  ...
  },
  {
    ...
    description: "A curated collection of our most provocative, complex cocktails. Four 187mL bottles — Pheromone Martini, Mezcal Soda, Whiskey Sour, and Blackberry Smash — each one clarified, carbonated, and ready to pour. Smoky depth, bright berries, and exotic allure. For the evenings that call for something darker.",
    ingredients: "Pheromone Martini, Mezcal Soda, Whiskey Sour, Blackberry Smash",
    spirit: "Variety",
    price: "34.99",
    volume: "4 x 187mL",
    servings: 4,

...
const seedProducts = [
  {
    ...
    description: "A sophisticated take on the classic Shirley Temple, elevated with premium vodka. The entire cocktail is clarified to a stunning translucent pink hue, then carbonated for a crisp, effervescent finish. Bright grenadine sweetness meets fresh lime in a sparkling cocktail that looks like liquid jewels and drinks like velvet.",
  ...
  },
  {
    ...
    description: "A breathtaking modern smash that balances power with elegance. Premium bourbon meets the deep, tart sweetness of ripe blackberries and bright lemon, then the entire cocktail is clarified to a stunning, translucent jewel-toned purple. Carbonated for a lively, effervescent lift. Rich, refreshing, and endlessly complex.",
    ingredients: "Bourbon, Blackberry, Fresh Lemon, Carbonated",
    spirit: "Bourbon",
    price: 29.99,
    volume: "750mL",
    servings: 5,
  ...
  },
  {
    ...
    description: "Our most provocative creation. Premium bourbon meets tropical passionfruit and a whisper of dark chocolate, then the entire cocktail is clarified to a pale amber. Carbonated for a silky effervescence that carries waves of exotic fruit and rich cacao. Intoxicating in every sense — a cocktail that pulls you in and doesn't let go.",
  ...
  },
  {
    name: "Lovingly Light",
    slug: "lovingly-light",
    tagline: "Four bright favorites in one box.",
    description: "A curated collection of our most radiant, uplifting cocktails. Four 187mL bottles — Clover Club, Strawberry Daiquiri, Blackberry Smash, and Dirty Shirley — each one clarified, carbonated, and ready to pour. Bright berries, sparkling sweetness, and a touch of bourbon warmth. Perfect for sharing, gifting, or savoring one beautiful evening at a time.",
    ingredients: "Clover Club, Strawberry Daiquiri, Blackberry Smash, Dirty Shirley",
    spirit: "Variety",
    price: 34.99,
    volume: "4 x 187mL",
    servings: 5,
    abv: "12.5%",
    imageUrl: "/images/lovingly-light.png",
    color: "#e0708a",
    featured: true,
  },
  {
    name: "Dark & Seductive",
    slug: "dark-and-seductive",
    tagline: "Four bold indulgences in one box.",
    description: "A curated collection of our most provocative, complex cocktails. Four 187mL bottles — Pheromone Martini, Mezcal Soda, Whiskey Sour, and Orange Creamsicle — each one clarified, carbonated, and ready to pour. Smoky depth, creamy citrus intrigue, and exotic allure. For the evenings that call for something darker.",
    ingredients: "Pheromone Martini, Mezcal Soda, Whiskey Sour, Orange Creamsicle",
    spirit: "Variety",
    price: 34.99,
    volume: "4 x 187mL",
    servings: 5,
    abv: "12.5%",
    imageUrl: "/images/dark-and-seductive.png",
    color: "#a07040",
    featured: true,
  },
];

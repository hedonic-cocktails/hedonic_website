      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src="/images/logo-octopus.png" alt="Licit" className="w-10 h-10 object-contain" />
              <h3 className="font-display text-2xl tracking-wide" data-testid="text-footer-brand">LICIT</h3>
            </div>
        ...
        <div className="border-t border-border/30 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-muted-foreground" data-testid="text-copyright">
            &copy; {new Date().getFullYear()} Licit Cocktails. All rights reserved.
          </p>
